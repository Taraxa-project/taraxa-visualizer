...
export class PBFTBlockView extends Container {
  ...
  constructor(app: Application) {
    ...
    obj.on("pointerdown", () => {
      console.log('hash pbft', this.hashPBFT);
      console.log('hash model', this.model.hash);
      console.log('hash model pbft', this.model.hashPBFT);
      const blockData = { ...this.model, type: 'PBFT' };
